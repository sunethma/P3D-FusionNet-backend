...
if __name__ == '__main__':
    ...
    parser.add_argument("--precision", type=str, default='16-mixed',
                        help='Precision for training (32-true, 16-mixed, etc.)')
            
    parser.add_argument('--checkpoint_dir', type=str, default='/content/drive/MyDrive/Colab Notebooks/model_checkpoints_with_TNT',
                        help='Directory path in Google Drive to save checkpoints')
    ...
    # Create trainer with explicitly defined arguments
    trainer = pl.Trainer(
...
# Fit the model, resuming from checkpoint if provided
